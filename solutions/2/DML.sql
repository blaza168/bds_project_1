INSERT INTO public.user_status (status) VALUES ('status1');
...
INSERT INTO public.users (given_name, family_name, email, status_id, attachment_id)
VALUES ('blemca', 'pepa z depa', 'email@gmail.xyz', 1,1);
